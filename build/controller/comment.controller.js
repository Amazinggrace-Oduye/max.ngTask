...
var ipAddress_api_1 = __importDefault(require("../userAPi/ipAddress.api"));
...
CommentController.makeCommment = function (req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userIpAddress, _a, ip, city, country_name, data, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, ipAddress_api_1.default.getUserPublicAddress()];
                case 1:
                    userIpAddress = _b.sent();
                    _a = userIpAddress.data, ip = _a.ip, city = _a.city, country_name = _a.country_name;
                    data = __assign(__assign({}, req.body), { userip_address: ip + ", " + city + " " + country_name });
